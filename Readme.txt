...
id bot admin dan host pada telegram : @K0H4T35Tbot
id bot MyHajj pada telegram : @my_hajj_Bot

bot dijalankan menggunakan pycharm dan pastikan run as administrator
Jalankan Main.py untuk menjalankan kedua chatbot bersamaan.
